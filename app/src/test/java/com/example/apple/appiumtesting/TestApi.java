...
public class TestApi {
    ...
    public static void test() throws TestLinkAPIException {
        TestLinkAPIClient apiClient = new TestLinkAPIClient(DEV_KEY, SERVER_URL);
        String projectName = "hello project";
        String projectid = "PEaas";
        String suiteName = "hello test suit";
        String testCaseName = "test plan case";
